...
class DepartmentCECOS extends Component{
    constructor(props){
        super(props);
    ...
    SaveModelForm(){
        if (this.state.id !== null) {
            axios.put(`${ApiUrl}general/departmentscecos/${this.state.id}/`, this.state.data)
                .then(res => {
            ...
            axios.post(`${ApiUrl}general/departmentscecos/`, this.state.data)
                .then(res => {
                    this.setState(function (prev_State) {
                        return {
                            modal: {
					...
					this.props.history('/catalogs/departmentcecos/'+res.data.id);
                });
        }
    }
    ...
    reset(id){
        if (id !== null){
            axios.get(`${ApiUrl}general/departmentscecos/${id}/`)
                .then(res => {
                    this.setState(function (prev_State) {
                        return {
                            id:id,
    ...
    handleClose = () => {
        ...
        this.props.history('/catalogs/departmentscecos');
	}
    ...
    handleCloseAddMore = () => {
        ...
        this.props.history('/catalogs/departmentcecos/')
	}
...
export default function(props) {
    ...
    return <DepartmentCECOS {...props} params = {params} history={history} />;
}
