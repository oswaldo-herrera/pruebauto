...
class ModalReservationFilterCouponReport extends Component{
	...
	reset(data){
        ...
        if(start_date!==""&&due_date!==""){
            axios.get(`${ApiOperationsUrl}operation_report_list_filters/?start_date=${start_date}&due_date=${due_date}&property=${this.state.property}&type=${this.state.params.type}`)
            .then(res => {
                this.setState(
                    (prev_State) =>{
                        return {
	...
	onSubmit(e){
        e.preventDefault();
        var url = `${ApiOperationsUrl}operation_report_coupons/?start_date=${this.state.params.start_date}&due_date=${this.state.params.due_date}&property=${this.state.property}&hotels=${this.state.params.hotels.toString()}&sale_types=${this.state.params.sale_types.toString()}&operation_types=${this.state.params.operation_types.toString()}&type=${this.state.params.type}`;
...
export default function(props) {
    ...
    return <ModalReservationFilterCouponReport {...props} history={history} />;
}